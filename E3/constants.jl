...
##########
is_finaltest = true
n_simulations = is_finaltest ? 200 : 200;
####Type general:
# T; Tn; SO; SOn; F; Fn
...
criterion_initial = generate_asymptotic_values(1.0, 0.32, 0.15, 1.0, 1.0, 5.0) 
# criterion_initial = LinRange(0.25, 0.1, n_probes);#the bigger the later number, more close hits and CR merges. control merging  

criterion_final =  LinRange(0.25,0.2, 10)#LinRange(0.18, 0.23, 10)
...
z_time_p_val = Dict(
    ...
    :Tn  => asym_increase_shift(0.32, how_much_z, how_fast_z, n_lists-1),
    :SOn => asym_increase_shift(0.02, how_much_z, how_fast_z, n_lists-1),
